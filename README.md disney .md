...
**Analyzed 3.5 million ride wait time records across 39 Disney World attractions from 2018–2022.**

Built by [Rashid Kamara](https://github.com/Rashidkamara123) | Elysium Analytics
...
| Insight | Detail |
|---|---|
| 📦 Total Records Analyzed | 3,509,324 |
| 🎢 Total Rides Tracked | 39 |
| 📅 Date Range | 2018 → 2022 |
| ⏱️ Overall Avg Wait Time | 13.6 minutes |
| 🎠 Busiest Ride | Monorail (35.4 min avg) |
| 📆 Busiest Day | Saturday |
| 🕛 Peak Hour | 12:00 (noon) |
| 📉 COVID Low | 6.3 min avg (2020) |
| 📈 Post-COVID High | 19.6 min avg (2022) |
| ☀️ Hottest Month | August |
...
- **Source:** [Disneyland Visitors Data (100+ Rides) — Kaggle](https://www.kaggle.com/datasets/ayushtankha/hackthon)
...
```bash
# Clone the repo
git clone https://github.com/Rashidkamara123/disney-park-wait-time-analysis.git
...
🐙 [github.com/Rashidkamara123](https://github.com/Rashidkamara123)

---

*Part of the Elysium Analytics portfolio — focused on anime, gaming, entertainment, and travel data.*
